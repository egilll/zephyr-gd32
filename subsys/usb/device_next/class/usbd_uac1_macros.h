...
#define FEATURE_UNIT_CONTROLS_BY_IDX(i, entity)					\
	COND_CODE_1(IS_EQ(i, 0), (DT_PROP(entity, controls)),			\
		(COND_CODE_1(DT_NODE_HAS_PROP(entity, channel_controls),		\
			(DT_PROP_BY_IDX(entity, channel_controls, UTIL_DEC(i))),	\
...
#define FEATURE_UNIT_BMA_CONTROLS_BY_IDX(i, entity)				\
	FEATURE_UNIT_CONTROLS_BY_IDX(i, entity)
...
#define FEATURE_UNIT_DESCRIPTOR_LENGTH(entity)					\
	(7 + UTIL_INC(FEATURE_UNIT_NUM_CHANNELS(entity)))
