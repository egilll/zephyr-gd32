...
#define DHCPV4_OPTIONS_OPTION_OVERLOAD	52
...
#define DHCPV4_OPTIONS_MAX_MSG_SIZE	57
...
#define DHCPV4_OLV_MSG_CLIENT_ID	9 /* 2 + 1 (htype) + 6 (MAC) */
#define DHCPV4_OLV_MSG_MAX_SIZE		4 /* 2 + uint16 */

#define DHCPV4_OLV_END_SIZE		1

#define DHCPV4_OPTIONS_OVERLOAD_FILE	0x01
#define DHCPV4_OPTIONS_OVERLOAD_SNAME	0x02
