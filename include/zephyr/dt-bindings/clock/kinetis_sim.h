...
#define KINETIS_SIM_SDHCSRC_CORE_SYSTEM	0
#define KINETIS_SIM_SDHCSRC_PLLFLLSEL	1
#define KINETIS_SIM_SDHCSRC_OSCERCLK	2
#define KINETIS_SIM_SDHCSRC_EXTERNAL	3
